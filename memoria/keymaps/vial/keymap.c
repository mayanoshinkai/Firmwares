...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_minisub(
    ...
    KC_ESC , KC_PIPE, KC_DQT , KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_4   , KC_5   , KC_6   , KC_QUOT, _______,
  ...
  [3] = LAYOUT_minisub(
    ...
    _______, KC_LALT, _______,          _______,          _______,          _______, _______, _______, _______
  )
};
